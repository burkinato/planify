...
const FAMILIES = [
  ...
  ['bottom-guidance',   'TR Alt Talimat Şeridi','GENEL', 'Alt bantta talimat, lejand ve onay alanları bulunan geniş çizim düzeni.', 'bottomBand', '#059669', false],
  ['dual-instruction',  'Çift Talimat Paneli',  'KURUMSAL', 'Yangın ve acil durum talimatlarını iki dengeli kolonda verir.', 'dualRails', '#059669', true],
  ...
  ['approval-qr',       'Onay ve QR Alanlı',    'KURUMSAL', 'Revizyon, hazırlayan, onay ve QR alanları güçlü kurumsal çıktı.', 'approval', '#059669', true],
  ['compact-a4',        'Kompakt Talimatlı',    'SERBEST', 'A4 ve dar panolar için yoğun ama okunaklı yerleşim.', 'compact', '#059669', false],
  ['panoramic-a3',      'Panoramik A3',         'ENDÜSTRİ', 'Büyük kat planına öncelik veren geniş panoramik kompozisyon.', 'panoramic', '#0284c7', true],
  ['public-board',      'Kamu Duyuru Panosu',   'KAMU', 'Kamu alanları için net başlık, duyuru ve talimat hiyerarşisi.', 'public', '#059669', true],
  ['minimal-iso',       'Minimal ISO Çerçeve',  'SERBEST', 'Beyaz alanı yüksek, sakin ve denetim odaklı resmi şablon.', 'minimal', '#059669', false],
  ['technical-slate',   'Teknik Slate Kompozit','ENDÜSTRİ', 'Teknik tesisler için koyu başlık raylı endüstriyel kağıt düzeni.', 'technical', '#059669', true],
  ['wide-legend',       'Geniş Lejand Dizini',  'GENEL', 'Çok sembollü projelerde geniş lejand ve açıklama alanı sağlar.', 'legendHeavy', '#059669', false],
  ['response-team',     'Ekip ve Sorumlu Alanlı','KURUMSAL', 'Acil durum sorumlusu, yangın sorumlusu ve ekip bilgisi alanları içerir.', 'team', '#059669', true],
  ['premium-audit',     'Premium Denetim',      'PREMIUM', 'Denetim skoru, acil telefon ve resmi onay blokları güçlü premium düzen.', 'premiumAudit', '#059669', true],
