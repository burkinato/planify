...
export const MODULE_DEFINITIONS: TemplateModuleDefinition[] = [
  ...
  },
  {
    ...
    type: 'DrawingArea',
    label: 'Çizim Alanı',
    description: 'Konva tabanlı mimari plan, rota ve sembol çizim alanı.',
    tone: 'paper',
    requirement: 'required',
    ...
    defaultState: { title: 'Ana Çizim Alanı', body: '' },
  },
  {
  ...
  },
  {
    ...
    label: 'Tahliye Talimatı',
    description: 'Alarm, tahliye, toplanma ve yoklama adımları.',
    tone: 'green',
    requirement: 'required',
    ...
    defaultState: {
      ...
      body: '1. Sakin olun, paniğe kapılmayın.\n2. Alarm duyulduğunda alanı derhal terk edin.\n3. Plandaki en yakın acil çıkışa ilerleyin.\n4. Asansörleri kullanmayın, merdivenleri tercih edin.\n5. Duman varsa eğilerek veya sürünerek ilerleyin.\n6. Engelli, yaşlı ve hamile kişilere yardım edin.\n7. Toplanma alanında yoklama tamamlanana kadar ayrılmayın.',
    },
  },
  {
    id: 'mod-fire-instructions',
    type: 'FireInstructions',
    label: 'Yangın Talimatı',
    description: 'Alarm, 112, söndürücü ve güvenli tahliye adımları.',
    tone: 'red',
    requirement: 'recommended',
    ...
    defaultState: {
      ...
      body: '1. Yangını fark edince alarm butonuna basın.\n2. 112 numarasını arayarak itfaiyeyi bilgilendirin.\n3. Güvenliyse uygun söndürücü ile ilk müdahaleyi yapın.\n4. Söndürücü için pimi çek, hedefe tut, tetiği sık ve süpür.\n5. Kontrol altına alınamıyorsa tahliye edin.\n6. Kapıları kapatın ancak kilitlemeyin.\n7. Asansörleri kesinlikle kullanmayın.',
    },
  },
  {
    id: 'mod-legend',
  ...
  },
  {
    ...
    description: 'Bina dışı toplanma noktası veya vaziyet krokisi.',
    tone: 'blue',
    requirement: 'required',
  ...
  },
  {
    ...
    label: 'Onay / Revizyon',
    description: 'Hazırlayan, kontrol, onaylayan, tarih ve revizyon kaydı.',
    tone: 'neutral',
    requirement: 'required',
  ...
  },
  {
    ...
    description: 'Söndürme, kurtarma, koruma ve ilk yardım sorumluları.',
    tone: 'neutral',
    requirement: 'recommended',
    ...
    defaultState: {
      ...
      body: 'Tahliye: __________  |  Söndürme: __________\nKurtarma: __________ | İlk Yardım: __________',
    },
  },
  {
    ...
    label: 'Risk / Utility',
    description: 'Gaz, elektrik kesme noktaları ve özel risk alanları.',
    tone: 'red',
    requirement: 'recommended',
    ...
    defaultState: {
      title: 'RİSK VE KESME NOKTALARI',
      body: 'Elektrik ana kesici: __________\nDoğalgaz/yanıcı gaz vanası: __________\nKimyasal/parlama riski: __________\nTehlikeli alanlardan geçmeyen rota tercih edilmelidir.',
    },
  },
  {
    ...
    description: 'Engelli, yaşlı, gebe refakat ve erişilebilir çıkış bilgisi.',
    tone: 'blue',
    requirement: 'recommended',
    ...
    defaultState: {
      title: 'ERİŞİLEBİLİR TAHLİYE',
      body: 'Refakat sorumlusu: __________\nErişilebilir çıkış/yardım noktası planda işaretlenmelidir.',
    },
  },
  {
    ...
    description: 'Söndürücü, dolap, alarm, hidrant ve bakım notları.',
    tone: 'red',
    requirement: 'recommended',
    ...
    defaultState: {
      title: 'YANGIN EKİPMANI',
      body: 'Yangın tüpü: ___ adet\nYangın dolabı: ___ adet\nAlarm butonu: ___ adet\nHidrant: ___ adet',
    },
  },
  {
    id: 'mod-qr-info',
    ...
    description: 'Belge no, geçerlilik, QR ve dijital doğrulama alanı.',
    tone: 'info',
  ...
  },
  {
    ...
    type: 'Notes',
    label: 'Notlar',
    description: 'Ziyaretçi, alt işveren veya saha özel bilgilendirme notları.',
    tone: 'neutral',
    requirement: 'optional',
    ...
    defaultState: {
      title: 'ÖZEL NOTLAR',
      body: 'Ziyaretçi ve alt işverenler tahliye sorumlusunun yönlendirmesine uymakla yükümlüdür.',
    },
  },
];
